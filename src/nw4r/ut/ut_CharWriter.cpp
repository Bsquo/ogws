...
namespace nw4r
{
	namespace ut
	{
		...
		void CharWriter::SetupGXDefault()
		{
			...
			GXSetTevOrder(GX_TEV_STAGE_ID_0, GX_TEX_COORD_ID_0, GX_TEXMAP_0,4);
		...
		void CharWriter::LoadTexture(const Glyph & glyph)
		{
			...
			if (loadingTexture != mLoadingTexture)
			{
				...
				0.0f, 0.0f, 0.0f);
				GXLoadTexObj(&texObj, GX_TEXMAP_0);
		...
		void CharWriter::SetupGXWithColorMapping(Color color1, Color color2)
		{
			...
			GXSetTevOrder(GX_TEV_STAGE_ID_0, GX_TEX_COORD_ID_0, GX_TEXMAP_0, 0xFF);
			...
			GXSetTevColorOp(GX_TEV_STAGE_ID_0, 0, 0, 0, 1, 0);
			GXSetTevAlphaOp(GX_TEV_STAGE_ID_0, 0, 0, 0, 1, 0);
			GXSetTevOrder(GX_TEV_STAGE_ID_1, GX_TEX_COORD_ID_INVALID, GX_TEXMAP_INVALID, 4);
