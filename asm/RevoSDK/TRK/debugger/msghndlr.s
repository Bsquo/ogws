...
/* 800C21B4 000BD0B4  48 00 40 89 */	bl func_800C623C
lbl_800C21B8:
...
/* 800C220C 000BD10C  48 00 3C A1 */	bl func_800C5EAC
...
/* 800C223C 000BD13C  48 00 1C 5D */	bl func_800C3E98
...
/* 800C22DC 000BD1DC  48 00 3B D1 */	bl func_800C5EAC
...
/* 800C23B0 000BD2B0  48 00 3A FD */	bl func_800C5EAC
/* 800C23B4 000BD2B4  38 60 00 00 */	li r3, 0
/* 800C23B8 000BD2B8  48 00 02 00 */	b lbl_800C25B8
lbl_800C23BC:
/* 800C23BC 000BD2BC  48 00 1D 15 */	bl func_800C40D0
...
/* 800C2424 000BD324  48 00 3A 89 */	bl func_800C5EAC
...
/* 800C2484 000BD384  48 00 3A 29 */	bl func_800C5EAC
/* 800C2488 000BD388  38 60 00 00 */	li r3, 0
/* 800C248C 000BD38C  48 00 01 2C */	b lbl_800C25B8
lbl_800C2490:
/* 800C2490 000BD390  48 00 1A 31 */	bl func_800C3EC0
...
/* 800C24F0 000BD3F0  48 00 39 BD */	bl func_800C5EAC
...
/* 800C2550 000BD450  48 00 39 5D */	bl func_800C5EAC
...
/* 800C2598 000BD498  48 00 1B C5 */	bl func_800C415C
...
/* 800C25B4 000BD4B4  48 00 1B 2D */	bl func_800C40E0
lbl_800C25B8:
...
/* 800C25D8 000BD4D8  48 00 18 E9 */	bl func_800C3EC0
...
/* 800C2638 000BD538  48 00 38 75 */	bl func_800C5EAC
...
/* 800C2698 000BD598  48 00 38 15 */	bl func_800C5EAC
/* 800C269C 000BD59C  48 00 3B 5D */	bl func_800C61F8
lbl_800C26A0:
...
/* 800C2740 000BD640  48 00 37 6D */	bl func_800C5EAC
...
/* 800C2794 000BD694  48 00 28 01 */	bl func_800C4F94
...
/* 800C27B4 000BD6B4  48 00 22 D5 */	bl func_800C4A88
...
/* 800C27D4 000BD6D4  48 00 21 45 */	bl func_800C4918
...
/* 800C27F4 000BD6F4  48 00 1C ED */	bl func_800C44E0
...
/* 800C2938 000BD838  48 00 35 75 */	bl func_800C5EAC
...
/* 800C29E4 000BD8E4  48 00 34 C9 */	bl func_800C5EAC
...
/* 800C2A44 000BD944  48 00 25 51 */	bl func_800C4F94
...
/* 800C2A64 000BD964  48 00 20 25 */	bl func_800C4A88
lbl_800C2A68:
...
/* 800C2A84 000BD984  48 00 1E 95 */	bl func_800C4918
lbl_800C2A88:
...
/* 800C2AA4 000BD9A4  48 00 1A 3D */	bl func_800C44E0
lbl_800C2AA8:
...
/* 800C2B68 000BDA68  48 00 33 45 */	bl func_800C5EAC
...
/* 800C2C20 000BDB20  48 00 32 8D */	bl func_800C5EAC
...
/* 800C2C60 000BDB60  48 00 24 75 */	bl func_800C50D4
...
/* 800C2CE4 000BDBE4  3C 60 80 3A */	lis r3, lbl_80399348@ha
/* 800C2CE8 000BDBE8  54 00 10 3A */	slwi r0, r0, 2
/* 800C2CEC 000BDBEC  38 63 93 48 */	addi r3, r3, lbl_80399348@l
...
/* 800C2D78 000BDC78  48 00 31 35 */	bl func_800C5EAC
...
/* 800C2E40 000BDD40  48 00 30 6D */	bl func_800C5EAC
...
/* 800C2E68 000BDD68  48 00 22 6D */	bl func_800C50D4
...
/* 800C2F28 000BDE28  3C 60 80 3A */	lis r3, lbl_80399364@ha
/* 800C2F2C 000BDE2C  54 00 10 3A */	slwi r0, r0, 2
/* 800C2F30 000BDE30  38 63 93 64 */	addi r3, r3, lbl_80399364@l
...
/* 800C2FBC 000BDEBC  48 00 2E F1 */	bl func_800C5EAC
...
/* 800C3064 000BDF64  48 00 2E 49 */	bl func_800C5EAC
/* 800C3068 000BDF68  48 00 2A E9 */	bl func_800C5B50
...
/* 800C30E0 000BDFE0  48 00 2D CD */	bl func_800C5EAC
...
/* 800C316C 000BE06C  48 00 2D 41 */	bl func_800C5EAC
...
/* 800C3208 000BE108  48 00 2C A5 */	bl func_800C5EAC
